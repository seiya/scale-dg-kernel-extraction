...
|---:|---:|---:|---|---:|---:|---:|
| 7 | 274.9 | 274.9 | 変化なし | **292.3**（`p7_gap_study.md` §5、job `78030`） | **1.06×** | 1.10× |
...
§26.9 でも宣言を出していない（j 方向のタイル幅とブロック形状が未掃引）。**最速経路の順位はどの次数でも変わらない**
