...
| `CUDAFORTRAN_FUSED` | 1.268 | 340.6 | 6.10 | 15.2% | 3.90 | 49.3% | 5.07 | 64.1% |
...
p=31 / p=7 / p=15 / p=127 の `FUSED` 行**で、[`p31_gap_study.md`](p31_gap_study.md) §20
（job `69623`、718.2 µs）、[`p7_gap_study.md`](p7_gap_study.md)（job `70538`、
302.8 µs）、[`p15_gap_study.md`](p15_gap_study.md) §22（job `70951`、340.6 µs）、
